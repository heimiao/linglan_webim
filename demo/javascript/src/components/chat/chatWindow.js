...
module.exports = React.createClass({
    ...
    sdScreenshots:function(msg){
        msg.chatType = this.props.chatType;
        Demo.conn.send(msg);
        Demo.api.addToChatRecord(msg, 'img');
        Demo.api.appendMsg(msg, 'img');
    },
    ...
    render: function () {
        var className = this.props.roomId ? ' dib' : ' hide',
            props = {
                ...
                sendScreenshots:this.props.sendScreenshots,
        ...
        return (
            <div className={'webim-chatwindow ' + this.props.className}>
                ...
                <SendWrapper send={this.send} sdScreenshots={this.sdScreenshots} {...props} />
            </div>
        );
    }
});
